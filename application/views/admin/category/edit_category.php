...
//                                            if (isset($category['cat_name'])) {
                                                echo form_open_multipart('admin/category/category_update/'.$catIdUrl.'/'.$levelUrl.'', $attributes);
                                                ?>
                                                    <input type="hidden" name="cat_id" value="<?php echo $category['cat_id']; ?>"
                                                    <input type="hidden" name="cat_image_name" value="<?php echo $category['cat_image']; ?>"
                                                <?php
//                                            } else {
