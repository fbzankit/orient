                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap drp-lst">
                        ...
                        <div class="add-product">
                            <a href="<?php echo base_url() ?>admin/distributor/add_dis/<?php echo $ex_idd; ?>">Add Distributor</a>
                        </div>
                        <?php
                                ...
                                <tbody>
                                    ...
                                    foreach ($distributors as $key => $distributor) {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td>
                                                <!-- <a href="<?php echo base_url() ?>admin/distributor/index/<?php echo $distributor->dis_id; ?>"> -->
                                                <?php echo $distributor->dis_name; ?>
                                                <!-- </a> -->
                                            </td>
                                            <td><?php echo $distributor->ex_name; ?></td>
                                           <!--  <td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>admin/distributor/ex_edit/<?php echo $distributor->ex_id; ?>" data-toggle="tooltip" title=""  class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                <a href="<?php echo base_url() ?>admin/distributor/ex_del/<?php echo $distributor->ex_id; ?>" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure to delete?')" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
