                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap drp-lst">
                        ...
                        <div class="add-product">
                            <a href="<?php echo base_url() ?>admin/product/add_product">Add Product</a>
                        </div>
                        <?php
                                    ...
                                    $i = 1;
                                      foreach ($products as $product) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo '/includes/img/product/'.$product->Image; ?>" alt=""></td> 
<!--                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() ?>admin/product/product_edit/<?php echo $product->id; ?>" data-toggle="tooltip" title=""  class="pd-setting-ed" data-original-title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                <a href="<?php echo base_url() ?>admin/product/product_del/<?php echo $product->id; ?>" data-toggle="tooltip" title="Delete" onclick="return confirm('Are you sure to delete?')" class="pd-setting-ed" data-original-title="Trash"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
