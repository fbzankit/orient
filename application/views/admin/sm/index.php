                        ...
                        <div class="asset-inner">
                            <table>
                                <tbody>
                                    <tr>
                                        <th>No</th>
                                        <th>Sales Manager Nsme</th>
                                        <th>Area manager Nsme</th>
                                        <!-- <th>Status</th> -->
                                        <th>Action</th>
                                    </tr>
                                    <?php
                                    ...
                                    foreach ($sales_managers as $key => $sales_manager) {
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><a href="<?php echo base_url() ?>admin/executive/index/<?php echo $sales_manager->sm_id; ?>"><?php echo $sales_manager->sm_nsme; ?></a></td>
                                            <td><?php echo $sales_manager->sm_nsme; ?></td>
                                           <!--  <td>
