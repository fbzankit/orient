                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-status-wrap drp-lst">
                        ...
                        <div class="add-product">
                            <a href="<?php echo base_url() ?>admin/state_head/add_state/<?php echo $zone_idd; ?>">Add State Head</a>
                        </div>
                        <?php
                                    ...
                                    if(!empty($states[0])){
                                        ...
                                        // print_r($state);die;
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url() ?>admin/area_manager/index/<?php echo $state['state_id']; ?>"><?php echo $state['state_head_name']; ?></a></td>
                                                <td><?php echo $state['designation']; ?></td>
                                                <td><?php echo str_replace(',', '<br />', $state['statesAll_name']); ?></td>
                                           <!--  <td>
